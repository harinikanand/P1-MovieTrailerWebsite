# Import webbrowser module used to show the trailer of the movie
import webbrowser
...
poster URL, Youtube trailer URL, actors, release date, rating"""
    ...
    def __init__(self, movie_title, movie_storyline, movie_poster_image,
                 movie_trailer_youtube_url, movie_actors, movie_release_date,
                 movie_rating):

        # title, storyline, poster_image_url and trailer_youtube_url
        # actors, release_date and rating are instance variables of
        # Class Movie
    ...
    # instance method of Class Movie that shows the trailer
    # of the movie instance invoking this method
