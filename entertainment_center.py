...
# create an instance of Movie Class for the movie Casablanca and assign
# the object to local variable casablanca.
...
# create an instance of Movie Class for the movie Frozen and assign
# the object to local variable frozen.
frozen = media.Movie("Frozen",
                     "The film tells the story of a fearless princess who sets off on an epic journey \
                      alongside a rugged iceman, his loyal pet reindeer, and a naïve snowman to find \
                      her estranged sister, whose icy powers have inadvertently trapped the kingdom \
                      in eternal winter.",
...
# create an instance of Movie Class for the movie Imitation Game and assign
# the object to local variable imitation_game.
imitation_game = media.Movie("Imitation Game",
                     "It portrays the story British crypt analyst Alan Turing, who in the film is \
                      hired to decrypt German intelligence codes for the British government during \
                      World War II.",
...
# create an instance of Movie Class for the movie North by Northwest and assign
# the object to local variable north_by_northwest.
north_by_northwest = media.Movie("North by Northwest",
                     "North by Northwest is a tale of mistaken identity, with an innocent man pursued\
                      across the United States by agents of a mysterious organization who want to \
                      stop his interference in their plans to smuggle out microfilm containing \
                      government secrets.",
...
# create an instance of Movie Class for the movie Forest Gump and assign
# the object to local variable forest_gump.
forest_gump = media.Movie("Forest Gump",
                     "The story depicts several decades in the life of Forrest Gump, as low-witted \
                      and naïve, but good-hearted and athletically prodigious man from Alabama who \
                      witnesses, and in some cases influences, some of the defining events of the \
                      latter half of the 20th century in the United States",
...
# create an instance of Movie Class for the movie Beauty and the Beast and assign
# the object to local variable beauty_and_the_beast.
...
# create an instance of Movie Class for the movie Planes, Trains and Automobiles and assign
# the object to local variable planes_trains_automobiles.
planes_trains_automobiles = media.Movie("Planes, Trains and Automobiles",
                     "The film stars Steve Martin as Neal Page, a high-strung marketing executive,\
                      who meets Del Griffith, played by John Candy, an eternally optimistic, \
                      overly talkative, and clumsy showercurtain ring salesman who seems to live \
                      in a world governed by a different set of rules.",
...
# create an instance of Movie Class for the movie A Beautiful mind and assign
# the object to local variable a_beautiful_mind.
...
# create an instance of Movie Class for the movie Good Will Hunting and assign
# the object to local variable good_will_hunting.
...
# create an instance of Movie Class for the movie The Bourne Identity and assign
# the object to local variable bourne_identity.
bourne_identity = media.Movie("The Bourne Identity",
                     "The film is about action spy thriller film adaptation of Robert Ludlum's novel of the same name.",
...
movies = [casablanca, frozen, imitation_game, north_by_northwest, forest_gump, beauty_and_the_beast, planes_trains_automobiles, a_beautiful_mind, good_will_hunting, bourne_identity]

#Provide the movies list to open_movies_page method of fresh_tomotoes to generate the fresh_tomotoes.html page
